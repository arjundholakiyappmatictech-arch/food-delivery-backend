...
export default function DeleteAddressModal({ address, isDeleting, onConfirm, onCancel }) {
      ...
      >
         <div className="relative w-full max-w-sm rounded-2xl border border-[#E9E9E9] bg-white p-5 text-center shadow-xl">
            ...
            <p className="mt-1 text-xs leading-relaxed text-[#595959]">
               ...
               <span className="font-semibold capitalize text-[#02060C]">{address.label}</span> address?
            </p>
