...
export const SHOPPING_BAG_SVG = (
   <svg
      ...
      strokeLinejoin="round"
   >
      <path d="M17.5 8.75L15.0447 19.5532C15.015 19.684 15 19.8177 15 19.9518C15 20.9449 15.8051 21.75 16.7982 21.75H18"></path>
      <path d="M19.2192 21.75H4.78078C3.79728 21.75 3 20.9527 3 19.9692C3 19.8236 3.01786 19.6786 3.05317 19.5373L5.24254 10.7799C5.60631 9.32474 5.78821 8.59718 6.33073 8.17359C6.87325 7.75 7.6232 7.75 9.12311 7.75H14.8769C16.3768 7.75 17.1267 7.75 17.6693 8.17359C18.2118 8.59718 18.3937 9.32474 18.7575 10.7799L20.9468 19.5373C20.9821 19.6786 21 19.8236 21 19.9692C21 20.9527 20.2027 21.75 19.2192 21.75Z"></path>
      <path d="M15 7.75V5.75C15 4.09315 13.6569 2.75 12 2.75C10.3431 2.75 9 4.09315 9 5.75V7.75"></path>
      <path d="M10 10.75H12.5"></path>
   </svg>
);

export const SHOPPING_BAG_SVG2 = (
   <svg className="h-full w-full" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
      <path d="M8 2C7.31377 2 6.72293 2.48437 6.58835 3.15728L6.2198 5H4.1802L4.62719 2.76505C4.94874 1.15729 6.3604 0 8 0C9.6396 0 11.0513 1.15729 11.3728 2.76505L11.8198 5H9.7802L9.41165 3.15728C9.27707 2.48437 8.68623 2 8 2Z" />

      <path d="M15 15H1V13L2 7H14L15 13V15Z" />
   </svg>
);

export const LOCATION_SVG = (
   <svg
      className="h-full w-full scale-y-110"
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
      strokeWidth="2"
